   ...
   <body>
      ...
      <div id="container">
         <div id="content" style="text-align: center;">
            ...
            <table id="studentsTable" class="table table-dark table-bordered" style="color: #ac6bfb;">
               <thead>
                  <tr>
                     <th>First Name</th>
                     <th>Last Name</th>
                     <th>Email</th>
                     <th>Phone Number</th>
                     <th>Is Undergraduate </th>
                     <th>Registration Year </th>
                     <th>Semester </th>
                     <th>Owes </th>
                     <th>Is Eligible </th>
                     <security:authorize access="hasAnyRole('ADMIN', 'SECRETARY')">
                        <th>Action</th>
                     </security:authorize>
                  </tr>
               <thead>
